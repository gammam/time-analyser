...
The application uses a **PostgreSQL database** via **Drizzle ORM**. Key features include upsert logic for meeting data and scores, Zod for input validation, and a schema defined for users, sessions, meetings, meetingScores, challenges, achievements, and JIRA-related entities (`jiraTasks`, `dailyCapacities`, `taskPredictions`). Migrations are managed via Drizzle.
